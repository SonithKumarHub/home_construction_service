...
<!-- Mirrored from livewp.site/html/bricks/portfolio-square.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 06:36:20 GMT -->
									...
									<ul>		
										<li data-transition="fade">			
											...
											<div class="tp-caption WhiteTtl px40 tp-resizeme" 
	                                            ...
	                                            data-start="1300"
												data-responsive_offset="on">find your labours
											</div>
											...
											<div class="tp-caption WhiteTtlp" 
	                                            ...
	                                            data-transform_out="opacity:0;s:500;s:500;"
												data-start="1600" >
												<input type="search" name="search" class="form-control search_content_input bez_2 " placeholder="   search labour here" onkeyup="searchlab(this.value)" style="height: 40px; color:black; background-color:floralwhite; ">
											</div>
										</li>
									</ul>
								</div>
			...
			<section class="portfolio-section masonry">
				<div class="isot-filters">
					<ul class="clean-list">
						...
						<!-- <li><a class="current" data-filter=".buildings" href="">buildings</a></li> -->
	                            ...
	                            <div class="widget-body">
	                            	<ul class="contact-info clean-list">
	                            		...
	                            		<li>
		                            		...
		                            		<p><a href="https://livewp.site/cdn-cgi/l/email-protection#d8bdb5b9b1b498bfacebacb0bdb5bdabf6bbb7b5"><span class="__cf_email__" data-cfemail="492c24282025092e3d7a3d212c242c3a672a2624">[email&#160;protected]</span></a></p>
	                            		</li>
	                            		<li>
...
<script src="custom2.js"></script>
	...
	items_set = [                    
			{src : 'img/portfolio-wall-1.jpg', url : 'single-portfolio.html', columnclass: 'col-md-3 col-xs-6', category: 'architecture', title: 'Project With slider', itemcategory: '<li><a href="#">Construction</a></li><li><a href="#">Design</a></li>'},
			{src : 'img/portfolio-wall-2.jpg', url : 'single-portfolio.html', columnclass: 'col-md-3 col-xs-6', category: 'constructions', title: 'gallery project', itemcategory: '<li><a href="#">Construction</a></li><li><a href="#">Design</a></li>'},
			{src : 'img/portfolio-wall-3.jpg', url : 'single-portfolio.html', columnclass: 'col-md-3 col-xs-6', category: 'buildings', title: 'Fullwidth video project', itemcategory: '<li><a href="#">Construction</a></li><li><a href="#">Design</a></li>'},
			{src : 'img/portfolio-wall-4.jpg', url : 'single-portfolio.html', columnclass: 'col-md-3 col-xs-6', category: 'architecture', title: 'Project With slider', itemcategory: '<li><a href="#">Construction</a></li><li><a href="#">Design</a></li>'},
		];
		jQuery('.isot-projects-wrapper').portfolio_more({
			load_count : 4,
			items : items_set,
			template: 'masonry'
		});
...
<!-- Mirrored from livewp.site/html/bricks/portfolio-square.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 06:36:24 GMT -->
</html>