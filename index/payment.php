...
<!-- Mirrored from livewp.site/html/bricks/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 06:36:34 GMT -->
								...
								<div class="blog-post">
									<div>
										<a href="single-post.html">
											<img src="img/qrcode.jpg" alt="blog post" style="margin-left:300px">
										</a>
									</div>
                                          <div style="margin-left:300px">
	                            	<form action="../controller/payment.php" method="POST" >
					<h6 class="title"><a href="#">Rs.<?php  echo $_GET['amt']?></a></h6>	                            
	                            </div>

	                    	
	                    			<input type="hidden"  value="<?php echo $_GET['rid'] ?>" name="rid">

	                    			                    			<input type="hidden"  value="<?php echo $_GET['amt'] ?>" name="amount">


	                    			<button class="btn grey" type="submit" style="margin-left:300px "]>Pay</button>
	                    			</form>
								</div>
	                            ...
	                            <div class="widget-body">
	                            	<ul class="contact-info clean-list">
	                            		...
	                            		<li>
		                            		...
		                            		<p><a href="https://livewp.site/cdn-cgi/l/email-protection#5a3f373b33361a3d2e692e323f373f2974393537"><span class="__cf_email__" data-cfemail="f7929a969e9bb79083c4839f929a9284d994989a">[email&#160;protected]</span></a></p>
	                            		</li>
	                            		<li>
