					...
					<div class="row">
						<div class="col-md-9 col-content" style="margin-left: 150px">
							...
							<div class="contact_form">
								<div id="note"></div>
								<div id="fields">
									<form class="respond-form"  action="../controller/book.php" method="POST">
										<h6>Drop us a line</h6>
										<div class="row">
											<div class="col-md-6">
												<div class="input-line">
											
													<input type="text" name="c_name" placeholder=" Name"class="check-value" value="" required="" />
												</div>

												<div class="input-line">
													<input type="text" name="address" placeholder="Address"class="check-value" value="" required="" />
													<input type="hidden" name="lid"  class="" value=" 
													<?php echo $_GET['lid'] ?>" />
													
												</div>
												<div class="input-line">
													<input type="text" name="phone" placeholder="Phone" class="check-value" value="" required="" pattern="[6-9]{1}[0-9]{9}"  />
													
												</div>
												<div class="input-line">
													<input type="date" name="date" placeholder="Date" class="check-value" value="" required="" />
													
												</div>
												<div class="input-line">
													<input type="time" name="time" placeholder="Time"  class="check-value" value="" required="" />

												</div>
												<div class="input-line">
													<input type="text" name="days" placeholder="Days" class="check-value" value="" required="" />
										...
										<div class="input-line textarea">
											<textarea class="check-value" name="req" placeholder="Type here"></textarea>
