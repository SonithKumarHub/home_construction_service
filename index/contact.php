			...
			<div class="top-header">
                <div class="container">
                    <ul class="contacts">
                        ...
                        <li><a href="https://livewp.site/cdn-cgi/l/email-protection#076e6961684764686a7766697e2964686a"><i class="fa fa-envelope"></i><span class="__cf_email__" data-cfemail="2e474048416e4d41435e4f4057004d4143">[email&#160;protected]</span></a></li>
                    </ul>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-9 col-content">
							...
							<div class="entry">
								<h6>say hello</h6>
								<p class="description">Ut pretium libero magna, eu scelerisque sem sollicitudin vitae. Pellentesque habitant morbi tristique senectus et netus et malesuadaer fames ac turpis egestas. Aenean id ultrices eros, in varius eros. Nunc a condimentum metus. Sed aliquet congue mi eget tempus. Praesen interdum enim sed porta finibus. Integer et nulla cursus velit porttitor volutpat in id orci. Cras tempor augue lectus. Nam a blandit ex.</p>
								<p class="info">121 King Street, Melbourne Victoria 3000 Australia</p>
								<p class="info">+1 (800) 456 37 96 - Office</p>
								<p class="info"><a href="https://livewp.site/cdn-cgi/l/email-protection#0a6f676b63664a6d7e397e626f676f7924696567"><span class="__cf_email__" data-cfemail="56333b373f3a16312265223e333b33257835393b">[email&#160;protected]</span></a></p>
							</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="input-line">
													<input type="text" name="name" class="check-value" value="" />
													<span>Name</span>
												</div>

												<div class="input-line">
													<input type="text" name="email" class="check-value" value="" />
													<span>Email</span>
												</div>
											</div>
										</div>
								...
								<div class="row isotope">
				                    ...
				                    <div class="col-md-12 col-sm-6 col-xs-12 isotope-item">
				                        <div class="widget widget_text">
											<img src="img/sidebar-banner-image.jpg" alt="sidebar banner">
				                        </div>
				                    </div>
