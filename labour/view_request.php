            ...
            <!-- Table Start -->
                    ...
                    <div class="col-sm-12 col-xl-8">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4"style="color:black; font-size: 28px">CLIENT REQUESTS</h6>
...
<?php
if($btn['status']==0){?>
  <td><div class="btn btn-success"><a href="../controller/approve_request.php?id=<?php echo $btn['r_id']?>&status=1" > approve</a></div>
    <div class="btn btn-danger"><a href="../controller/reject.php?id=<?php echo $btn['r_id']?>&status=1" > Reject</a></div></td>
<?php
}elseif($btn['status']==1){?>

  <td><div class="badge badge-success"><a href=""> APPROVED</a></div></td>

<?php }elseif($btn['status']==2)
{
?>
  <td><div class="badge badge-success"><a href=""> REJECTED</a></div></td>
