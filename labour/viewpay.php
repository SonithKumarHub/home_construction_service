            ...
            <!-- Table Start -->
                    ...
                    <div class="col-sm-12 col-xl-8">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4"style="color:black; font-size: 28px">Payment</h6>
...
<?php 
$lid=$_SESSION['lid'];
  $stmt=$admin->ret("SELECT * FROM tolpay where  l_id='$lid' ");
    while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
         $rid=$row['r_id'];
$abcd=$admin->ret("SELECT * FROM `request` WHERE `r_id`='$rid'");
$btn=$abcd->fetch(PDO::FETCH_ASSOC)
...
<?php
if($btn['status']==7){?>
  <td><div class="badge badge-success"><a  class="btn btn-success" style="">paid</a></div></td>
<?php
}else{?>

  <td><div class="badge badge-danger"><a class="badge badge-danger"> Unpaid</a></div></td>
<?php }
?>
