                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Quatation Form</h6>
                            <form action="../controller/quatation.php"method="POST">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Write Your Message</label>
                                  <textarea class="form-control" name="quatation"></textarea>
