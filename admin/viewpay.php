...
<?php 
$lid=$_SESSION['lid'];
$abcd=$admin->ret("SELECT * FROM `request` INNER JOIN tolpay ON tolpay.r_id=request.r_id  WHERE request.l_id='$lid' ");
...
?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $btn['request']?></td>
                         ...
                         <td><?php echo $btn['amount']?></td>
                       
                        
                           
<?php
if($btn['status']==7){?>
  <td><div class="badge badge-success"><a  class="badge badge-success">paid</a></div></td>
<?php
}else{?>
